...
* The OpenC2 Language Specification provides the semantics for the essential elements of the language, the structure for commands and responses, and defines the proper syntax for the language elements that represents the command or response.
...
OpenC2 is intended for machine to machine interactions, therefore an Annex with multiple examples of SLPF commands (JSON serialization) is provided to facilitate developers.   
